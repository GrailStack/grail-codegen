package com.itgrail.grail.codegen.custom.grailsimpleLayer;
...
/**
 * @author xujin created at 2021/11/17 20:50
 **/
@Component
@Slf4j
public class GrailSimpleLayerTemplate extends CustomizedTemplate {

	@Override
	public String getTemplateName() {
		return "grailsimpleLayer";
	}

	@Override
	public List<ModuleMetaData> initSubModules() {
		List<ModuleMetaData> subModules = Lists.newArrayList();
		ModuleMetaData moduleMetaData1=new ModuleMetaData().setSubModuleName("api").setPackagingTypes(Lists.newArrayList("jar"));
		ModuleMetaData moduleMetaData2= new ModuleMetaData().setSubModuleName("servcie").setPackagingTypes(Lists.newArrayList("jar", "war"));
		...
		if(StringUtils.isNotEmpty(json)){
			...
			for (ModuleDependencyModel mo:list) {
				if("api".equals(mo.getModulekey())){
					moduleMetaData1.setDependencys(mo.getDependencyModels());
				}
				if("service".equals(mo.getModulekey())){
	...
	public List<String> getSubModules() {
		return Lists.newArrayList("api","service");
